...
func (l *logger) Info(mes string, args ...interface{}) {
	printfMsg("INFO", 0, mes, args...)
}

func (l *logger) Warn(mes string, args ...interface{}) {
	printfMsg("WARN", 0, mes, args...)
}
func (l *logger) Error(mes string, args ...interface{}) {
...
func (l *logger) InfoDepth(mes string, depth int, args ...interface{}) {
	printfMsg("INFO", depth, mes, args...)
}

func (l *logger) WarnDepth(mes string, depth int, args ...interface{}) {
	printfMsg("WARN", depth, mes, args...)
}

func (l *logger) ErrorDepth(mes string, depth int, args ...interface{}) {
